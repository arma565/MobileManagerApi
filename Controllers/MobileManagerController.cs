...
{
    private readonly MobileManagerService _service;

    public MobileManagerController(MobileManagerService service)
    {
        _service = service;
    }
    ...
    #region Debtor
    [HttpGet("debtor/{id}")]
    public async Task<ActionResult<Debtor>> GetDebtor(int id)
    {
